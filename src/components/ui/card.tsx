...
const cardVariants = cva(
  "rounded-lg border text-card-foreground shadow-sm transition-all duration-300",
  {
    variants: {
      variant: {
        default: "bg-card hover:shadow-elegant hover:scale-[1.01] hover:-translate-y-0.5 active:scale-100 active:translate-y-0",
        crypto: "crypto-card bg-transparent hover:shadow-neon",
        glass: "glass-card-crypto",
        data: "bg-card/80 border-primary/20 hover:border-primary/40 hover:shadow-md",
