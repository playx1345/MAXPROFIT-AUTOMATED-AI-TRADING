        ...
        <div className="max-w-5xl mx-auto text-center">
          <div className="glass-card-enhanced rounded-2xl sm:rounded-3xl p-5 sm:p-8 md:p-10 lg:p-14 animate-scale-in">
            ...
            <h1 className="font-display text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-black mb-4 sm:mb-6 tracking-tight leading-[1.1]">
              <span className="opacity-0 animate-text-reveal text-gradient-premium drop-shadow-[0_0_35px_hsl(var(--primary)/0.4)] inline-block">
                Live Win Trade
              </span>
              <br />
              <span className="opacity-0 animate-text-reveal-delayed text-foreground text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold italic inline-block" style={{ animationDelay: '0.2s' }}>
                Investment
              </span>
            </h1>
            
            <p className="text-2xl sm:text-3xl md:text-4xl font-display font-semibold mb-4 sm:mb-5 opacity-0 animate-text-reveal" style={{ animationDelay: '0.4s' }}>
              <span className="text-gradient-accent">AI Trading Platform</span>
            </p>

            {/* Subtitle */}
            <p className="text-lg sm:text-xl md:text-2xl text-foreground/70 mb-8 sm:mb-10 max-w-3xl mx-auto leading-relaxed px-2 font-sans font-light opacity-0 animate-text-reveal" style={{ animationDelay: '0.6s' }}>
