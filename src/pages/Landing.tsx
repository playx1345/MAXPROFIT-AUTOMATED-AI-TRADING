    ...
    <div className="min-h-[100dvh] bg-background overflow-x-hidden">
      ...
      <section id="features" ref={featuresRef.ref} className="relative py-12 sm:py-16 lg:py-20 bg-muted/30">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className={`text-center mb-10 sm:mb-12 lg:mb-16 transition-all duration-400 ${featuresRef.isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            <FeatureCard icon={Bot} title="AI Trading Bot" description="Advanced algorithms analyze market trends and execute trades automatically with precision and speed" />
            <FeatureCard icon={Shield} title="Secure Platform" description="Bank-level security with KYC verification, encrypted transactions, and cold storage protection" />
            <FeatureCard icon={TrendingUp} title="Performance Tracking" description="Real-time portfolio monitoring with detailed profit/loss analytics and comprehensive reports" />
            <FeatureCard icon={Users} title="Referral Program" description="Earn generous bonuses when your referrals make their first deposit and start trading" />
          </div>
        </div>
      </section>
      ...
      <section id="plans" ref={plansRef.ref} className="relative py-12 sm:py-16 lg:py-20">
        <div className="container mx-auto px-4">
          <div className={`text-center mb-10 sm:mb-12 lg:mb-16 transition-all duration-400 ${plansRef.isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-serif font-bold mb-3 sm:mb-4 shimmer-text">
              Investment Plans
            </h2>
            <p className="text-base sm:text-lg lg:text-xl text-muted-foreground max-w-2xl mx-auto font-serif px-4">
      ...
      <section id="how-it-works" ref={howItWorksRef.ref} className="relative py-12 sm:py-16 lg:py-20 bg-muted/30">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className={`text-center mb-10 sm:mb-12 lg:mb-16 transition-all duration-400 ${howItWorksRef.isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-serif font-bold mb-3 sm:mb-4 shimmer-text">
              How It Works
            </h2>
      ...
      <section id="faq" ref={faqRef.ref} className="relative py-12 sm:py-16 lg:py-20">
        <div className="container mx-auto px-4">
          <div className={`text-center mb-10 sm:mb-12 lg:mb-16 transition-all duration-400 ${faqRef.isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-serif font-bold mb-3 sm:mb-4 shimmer-text">
          ...
          <div className={`transition-all duration-400 delay-200 ${faqRef.isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <FAQ />
          </div>
        </div>
      </section>
