...
export const InviteEmail = ({ siteName, siteUrl, confirmationUrl }: InviteEmailProps) => (
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>You've been invited to Win-Tradex</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>You've been invited to join <Link href={siteUrl} style={link}><strong>Win-Tradex</strong></Link>. Click below to accept and create your account.</Text>
